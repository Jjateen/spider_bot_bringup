...
Publishes sensor_msgs/JointState sized like the real /joint_states (12
joints, name+position+velocity), header.stamp set from wall-clock
(RCL_STEADY_TIME, independent of any /clock or sim time) so the subscriber
can compute one-way transport latency directly.

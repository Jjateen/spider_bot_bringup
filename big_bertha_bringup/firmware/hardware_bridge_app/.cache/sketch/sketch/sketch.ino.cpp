...
//   MCU pushes IMU / status via Bridge.notify; Python caches it.
//   Python sends servo commands via Bridge.notify, MCU receives locally.
...
// ── RPC handlers (receive notifications from Python) ─────────────────────
